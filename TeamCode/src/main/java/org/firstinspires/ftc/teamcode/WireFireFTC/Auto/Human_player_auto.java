...
public class Human_player_auto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        sleep(375);
        stopMotors();
        setSlidesrotation(1155,1.0);//1160
        sleep(375);
        setSlidesrotation(1240,0.4);//1245
        sleep(670);
        setSlides(2550,0.8);
        sleep(1400);
        setIntakeHand(0.2);
        sleep(100);
        setSlidesrotation(0, 1.0);
        setSlides(0, 1.0);
        sleep(250);
        movement(0.2,-0.5,0.0,0.0);
        sleep(200);
        stopMotors();
        movement(0.69, 0.0, -0.7, 0.0);
        sleep(510);
        stopMotors();
        movement(0.4, 0.9, 0.0, 0.0);
        sleep(200);
        stopMotors();
        movement(0.23, 0.0, 0.0, 0.6);
        sleep(300);
        stopMotors();
        movement(0.3, 0.4, 0.0, 0.0);
        stopMotors();
        sleep(160);
        ...
        stopMotors();
        sleep(160);
        movement(0.22,-0.5,0.0,0.0);
        stopMotors();
        sleep(150);
        movement(0.98, 0.0, 1.0, 0.0);
        stopMotors();
        sleep(160);
        movement(0.35, 0.6, 0.0, 0.0);
        stopMotors();
        sleep(160);
        movement(0.1,0.0,0.0,0.3);
        stopMotors();
        ...
        stopMotors();
        sleep(160);
        movement(0.53, 0.0, 0.0, -0.6);
        stopMotors();
        sleep(160);
        movement(0.15,0.0,1.0,0.0);
        stopMotors();
        intakeWristRotation = 0.43;
