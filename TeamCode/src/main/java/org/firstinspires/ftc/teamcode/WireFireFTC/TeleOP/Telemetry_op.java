...
@TeleOp(name = "Telemetry-TeleOp",group = "Linear OpMode")
public class Telemetry_op extends LinearOpMode {
    //Used for Telemetry
    ...
    int rotation = 0;
    final int ROTATION_INCREMENT = 3;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            */
            ...
            telemetry.addData("HandServo", intakeServo.getPosition());
    ...
    private void setIntakeServo(double hand){
        intakeServo.setPosition(hand);
    }
